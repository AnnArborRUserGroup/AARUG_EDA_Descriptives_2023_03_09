...
```
Sometimes you want to clean this up - use the <strong><h3>kable</strong></h3> command:
...
gapminder %>%
  ...
  kable(caption = "<strong><center> Types</center></strong>", full_width = F) %>%
...
## Summary table using <strong><h3>pastecs</strong></h3> package:
